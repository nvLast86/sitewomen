# Generated by Django 4.2.10 on 2024-08-24 18:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=255, unique=True, validators=[django.core.validators.MinLengthValidator(5, message='Минимум 5 символов'), django.core.validators.MaxLengthValidator(255, message='Максимум 255 символов')], verbose_name='Slug')),
                ...
                ('is_published', models.BooleanField(choices=[(True, 'Черновик'), (True, 'Опубликован')], default='0', verbose_name='Статус')),
