# Generated by Django 4.2.10 on 2024-07-30 09:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='women',
            name='is_published',
            field=models.BooleanField(choices=[(True, 'Черновик'), (True, 'Опубликован')], default='0', verbose_name='Статус'),
        ),
        migrations.AlterField(
            model_name='women',
            name='slug',
            field=models.SlugField(max_length=255, unique=True, validators=[django.core.validators.MinLengthValidator(5, message='Минимум 5 символов'), django.core.validators.MaxLengthValidator(255, message='Максимум 255 символов')], verbose_name='Slug'),
        ),
        migrations.AlterField(
            model_name='women',
            name='tags',
